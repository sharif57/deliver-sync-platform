...
//   return (
//     <>
//       <section className="relative   bg-heroBg overflow-hidden">
...
//             {/* Left Content */}
            ...
            //   <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-5xl font-medium text-gray-900 leading-tight mb-6">
            //     Simplify Your Parts Delivery <span className="text-green-600">-Track, Manage, Deliver</span>
            //   </h1>
            ...
            //       className="border-2 border-gray-300 text-gray-700 hover:bg-gray-50 px-8 py-4 text-lg font-semibold rounded-lg flex items-center gap-2 transition-all duration-200 bg-transparent"
            //     >
...
export default function HeroSection() {
  ...
  return (
    <>
    <section className="bg-[#E6F0E6] " style={{ height: '600px' }}>
