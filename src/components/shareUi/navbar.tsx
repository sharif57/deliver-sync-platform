...
//                                     <DropdownMenuSeparator />
//                                     <Link href="/profile" className='cursor-pointer'><DropdownMenuItem>Profile</DropdownMenuItem></Link>
//                                     <Link href={`/${localPath}`} className='cursor-pointer'><DropdownMenuItem className='capitalize'>{localPath}</DropdownMenuItem></Link>
//                                     <Link href="/change-password" className='cursor-pointer'><DropdownMenuItem>Change Password</DropdownMenuItem></Link>
//                                     <DropdownMenuSeparator />
