...
//     switch (activeFilter) {
//       case "Ongoing":
//         filtered = deliveryData.filter((item) => item.status === "Processing" || item.status === "Ongoing")
//         break
//       case "Delivered":
...
//           filtered = deliveryData.filter((item) => item.dateObj.toDateString() === selectedDateStr)
//         }
//         break
//       case "All":
//       default:
...
//       const hasDelivery = deliveryData.some((item) => item.dateObj.toDateString() === date.toDateString())
...
//               <h1 className="text-2xl font-medium text-secondary">Delivery History</h1>
//             </div>
//           </div>
//         </div>
...
//                     }
//                   }}
//                   className={`py-2 rounded-lg px-1 text-sm font-medium border-b-2 whitespace-nowrap transition-colors flex items-center gap-2 ${activeFilter === filter
//                     ? "border-orange bg-gradient-to-b from-[#E0B351] to-[#8B6E31] px-8  text-white "
//                     : "border-transparent text-gray-500 hover:text-gray-700"
//                     }`}
//                 >
//                   {filter === "Calendar" && <Calendar className="w-4 h-4" />}
//                   {filter === "Calendar" ? (selectedDate ? selectedDate.toLocaleDateString() : "Calendar") : filter}
//                 </button>
...
//             <div className="px-4 py-8 text-center text-gray-500">No deliveries found for the selected criteria</div>
//           ) : (
//             filteredData.map((item, index) => (
//               <Link href={`/customer/track-my-order`}
//                 key={item.id}
//                 className={`flex items-center justify-between px-4 cursor-pointer bg-heroBg rounded-3xl  m-4 py-4 ${index !== filteredData.length - 1 ? "border-b border-gray-100" : ""
//                   } hover:bg-accent transition-colors`}
//               >
//                 <div className="flex-1 flex items-center gap-5">
//                   <div className="flex items-center gap-3 mb-1">
//                     <span className="text-sm font-medium text-gray-900">ID: {item.orderId}</span>
//                     <span className="text-xs text-gray-500">{item.date}</span>
//                   </div>
//                   <span className={`text-sm font-medium text-primary ${getStatusColor(item.statusColor)}`}>{item.status}</span>
//                 </div>
//                 <div className="bg-white p-2 rounded-lg">
//                   <ChevronRight className="w text-black" />
//                 </div>
//               </Link>
//             ))
//           )}
