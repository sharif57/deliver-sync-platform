        ...
        <div>
            ...
            <div>
                <div className='bg-white p-10 rounded-lg  flex flex-col items-center gap-4'>
                    <p className='text-[#012F64] text-5xl font-semibold text-center'> + 47.80 XAF</p>
                </div>
                ...
                <div className='w-1/3 mx-auto'>
                    <button className='bg-primary w-full mt-6 text-white py-3 rounded-full font-medium hover:bg-blue-700 transition-colors duration-300'>Process</button>
                </div>
            </div>
        </div>
    )
