...
//                             </div>
//                             <div>
//                                 <p className="text-[#D69D21] text-[16px] cursor-pointer font-normal">ID#{orderDetails?.order_id}</p>
...
const RouteInfo = ({ distance, duration }: { distance?: string; duration?: string }) => (
    <div className="absolute top-[290px] bg-white p-3 rounded-lg shadow-lg z-10 border">
    ...
    return (
        <div className="min-h-screen ">
            ...
            <div className="container mx-auto px-4 py-6">
                ...
                {/* Main Content Card */}
                <div className="bg-white rounded-2xl sm:rounded-3xl shadow-lg p-4 sm:p-6 lg:p-8 mt-4 sm:mt-6">
                            ...
                            <div className=" flex  items-center w-1/2 mt-8">
                                <div className="flex  gap-4 w-full max-w-sm">
                                    <Button
                                        onClick={() => handleAcceptDelivery(orderDetails?._id)}
                                        disabled={loading}
                                        className="flex-1 text-base cursor-pointer px-14 bg-gradient-to-r from-[#EFB639] to-[#C59325] text-white py-6 rounded-lg font-medium hover:bg-primary/90 transition"
                                        aria-label="Decline request"
                                    >
                                        {loading ? "Accepting..." : "Accept Request"}
                                    </Button>
                                    <Button
                                        ...
                                        onClick={() => window.open(`https://wa.me/${orderDetails?.customer_details?.phone_number}`)}
                                        variant="outline"
                                        className="w-full cursor-pointer flex-1 border border-gray-300 px-14 text-secondary text-base py-6 rounded-lg font-medium hover:bg-gray-100 hover:border-gray-400 transition"
                                        aria-label="Accept request"
                                    >
                                        Call to company
                                    </Button>
