                    ...
                    <div className="flex flex-col sm:flex-row justify-between gap-14">
                        <div className="w-full sm:w-1/2">
                            ...
                            <div className=" flex  items-center lg:w-1/2 mt-8">
                                <div className="lg:flex  gap-4 w-full max-w-sm space-y-4">
                                    <div>
                                        <Link href={'/driver/picked_order'} className="flex-1">
                                            <Button
                                                onClick={() => handleParcel(orderDetails?._id)}
                                                className="w-full cursor-pointer text-base px-14 bg-gradient-to-r from-[#EFB639] to-[#C59325] text-white py-6 rounded-lg font-medium hover:bg-primary/90 transition"
                                                aria-label="Decline request"
                                            >
                                                {loading ? 'Delivering' : 'Deliver the parcel'}
                                            </Button>
